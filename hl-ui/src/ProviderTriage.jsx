    ...
    return (
        ...
        >
            <div style={{ width: 'min(1200px, 100%)', margin: '0 auto' }}>
                ...
                >
                    {/* FIX: use red / orange / yellow to match backend groups */}
                                                            ...
                                                            <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginTop: 10 }}>
                                                                ...
                                                                <span style={{ marginLeft: 'auto' }}>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <option value="orange">Moderate (Yellow)</option>
                                                                        <option value="yellow">Routine (Green)</option>
                                                                    </select>
                                                                </span>
                                                            </div>
                                                        </>
...
// UPDATED COLORS:
// - red: keep existing
// - orange (Moderate): yellow tone #6b5700
// - yellow (Routine): green #076815
function colorBg(c) {
    if (c === 'red') return '#dc2626';
    if (c === 'orange') return '#6b5700';  
    if (c === 'yellow') return '#076815';  
    return '#076815';                      
}
